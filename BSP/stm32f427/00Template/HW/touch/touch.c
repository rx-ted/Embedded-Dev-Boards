...
device_result_code_t _touch_init();
uint8_t _touch_scan();
...
device_result_code_t check_touch_setup_param_by_id()
{
    printf("12345");
    ...
    printf("[E][touch]: Not found lcd controller!\n");
...
void touch_init()
{
    ...
    touch_hw_reset();
    touch_iic_init();
    device_result_code_t res = check_touch_setup_param_by_id();
